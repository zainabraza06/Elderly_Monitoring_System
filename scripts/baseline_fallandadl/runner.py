...
def main():
    ...
    parser.add_argument(
        "--npz-path",
        required=True,
        help="Path to .npz with arrays: X_train_raw, y_fall_train, X_test_raw, y_fall_test, X_train_adl, y_train_adl, X_test_adl, y_test_adl.",
    )
    ...
    if not os.path.exists(args.npz_path):
        print(f"Missing data file: {args.npz_path}")
        return 1
